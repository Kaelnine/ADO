			...
			using (NpgsqlConnection connection = new NpgsqlConnection(Options.ConnectionString))
			{
				...
				while (reader.Read())
				{
					...
					TaskDto task = new TaskDto()
					{
						...
						IdManager = reader.GetInt32(5),
						NameManager = reader.GetString(6),
						IdStaff = reader.GetInt32(7),
						NameStaff = reader.GetString(8),
						AssignmentDate = reader.GetDateTime(9),
						PeriodExecution = reader.GetDateTime(10),
